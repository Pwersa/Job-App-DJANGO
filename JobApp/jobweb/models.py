...
class other_info(models.Model):
    ...
    company2 = models.CharField(verbose_name='company2',max_length=99, default="", null=True)
    position2 = models.CharField(verbose_name='position2', default="", max_length=99)
    from2 = models.CharField(verbose_name='from_2' ,max_length=99, default="", null=True)
    to2 = models.CharField(verbose_name='to_2' ,max_length=99, default="", null=True)
    ...
    ref2 = models.CharField(verbose_name='ref2',max_length=99, default="", null=True)
    refcon2 = models.CharField(verbose_name='refcon2', default="", max_length=99, null=True)
    refpos2 = models.CharField(verbose_name='refpos2',max_length=99, default="", null=True)
    refcom2 = models.CharField(verbose_name='refcom2',max_length=99, default="", null=True)
    philhealth = models.CharField(verbose_name='philhealth', max_length=99, null=True)
    pagibig = models.CharField(verbose_name='pagibig', max_length=99, null=True)
    TIN = models.CharField(verbose_name='TIN', max_length=99, null=True)
    NBI = models.CharField(verbose_name='NBI', max_length=99, null=True)
