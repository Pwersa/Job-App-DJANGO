...
class other_info(models.Model):
    ...
    to1 = models.CharField(verbose_name='to_1' ,max_length=99, default="", null=True)
    company2 = models.CharField(verbose_name='company2',max_length=99, default="", null=True, blank=True)
    position2 = models.CharField(verbose_name='position2', default="", max_length=99, blank=True)
    from2 = models.CharField(verbose_name='from_2' ,max_length=99, default="", null=True, blank=True)
    to2 = models.CharField(verbose_name='to_2' ,max_length=99, default="", null=True, blank=True)
    ref1 = models.CharField(verbose_name='ref1',max_length=99, default="", null=True)
    refcon1 = models.CharField(verbose_name='refcon1', default="", max_length=99, null=True)
    refpos1 = models.CharField(verbose_name='refpos1',max_length=99, default="", null=True)
    refcom1 = models.CharField(verbose_name='refcom1',max_length=99, default="", null=True)
    ref2 = models.CharField(verbose_name='ref2',max_length=99, default="", null=True, blank=True)
    refcon2 = models.CharField(verbose_name='refcon2', default="", max_length=99, null=True, blank=True)
    refpos2 = models.CharField(verbose_name='refpos2',max_length=99, default="", null=True, blank=True)
    refcom2 = models.CharField(verbose_name='refcom2',max_length=99, default="", null=True, blank=True)
    philhealth = models.CharField(verbose_name='philhealth', max_length=99, null=True, default="", blank=True)
    pagibig = models.CharField(verbose_name='pagibig', max_length=99, null=True, default="", blank=True)
    TIN = models.CharField(verbose_name='TIN', max_length=99, null=True, default="",blank=True)
    NBI = models.CharField(verbose_name='NBI', max_length=99, null=True, default="", blank=True)
    SSS = models.CharField(verbose_name='SSS', max_length=99, null=True, default="", blank=True)
    med_record = models.CharField(verbose_name='med_record', max_length=6, null=True, default="", blank=True)
    signature = models.ImageField(verbose_name='signature', default="", null=True)
