...
class other_info(models.Model):
    ...
    civilstatus = models.CharField(verbose_name='civilstatus' ,max_length=99, choices=citizenship_options)
    ...
    e_contact = models.IntegerField(verbose_name='e_contact' ,max_length=99)
    e_no = models.CharField(verbose_name='e_no' ,max_length=11)
    elementary = models.CharField(verbose_name='elementary' ,max_length=99)
    elementary_grad = models.IntegerField(verbose_name='elementary_grad' ,max_length=99)
    highschool = models.CharField(verbose_name='highschool' ,max_length=99)
    highschool_grad = models.IntegerField(verbose_name='highschool_grad' ,max_length=99)
    college = models.CharField(verbose_name='college' ,max_length=99)
    college_grad = models.IntegerField(verbose_name='college_grad' ,max_length=99)
    ...
    refcon1 = models.IntegerField(verbose_name='refcon1',max_length=11, default="")
    ...
    refcon2 = models.IntegerField(verbose_name='refcon2',max_length=11, default="")
    ...
    philhealth = models.IntegerField(verbose_name='philhealth', max_length=12)
    pagibig = models.IntegerField(verbose_name='pagibig', max_length=12)
    TIN = models.IntegerField(verbose_name='TIN', max_length= 9)
    NBI = models.IntegerField(verbose_name='NBI', max_length=6)
    SSS = models.IntegerField(verbose_name='SSS', max_length=10)
